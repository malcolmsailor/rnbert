...
#     ${RN_PREDS}/per_salami_slice_predictions/${SLURM_ID}_collated/test/key_pc_mode.csv --uniform-steps
...
#     metadata=${RN_PREDS}/per_salami_slice_logits/${SLURM_ID}_collated/test/metadata_test.txt \
#     logits_folder=${RN_PREDS}/per_salami_slice_logits/${SLURM_ID}_collated/test \
#     dictionary_folder=${RN_PREDS}/${SLURM_ID}/test \
...
#     input_csv=${RN_PREDS}/per_salami_slice_predictions/${SLURM_ID}_collated/test/key_pc_mode.csv \
#     output_csv=${RN_PREDS}/per_salami_slice_predictions/${SLURM_ID}_collated/test/key_pc_mode_per_score_metrics.csv
