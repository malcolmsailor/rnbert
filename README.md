This repository contains the code for implementing the model described in [my 2024 ISMIR paper](https://doi.org/10.5281/zenodo.14877455). If you find it useful, please cite the paper as follows:
